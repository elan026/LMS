...
export default function LoginPage() {
  const [email, setEmail] = useState('faculty@lms.com');
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-faculty-50 to-faculty-100">
      <div className="w-full max-w-md">
        <div className="card bg-white">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-faculty-600">LMS Faculty</h1>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2 text-xs text-gray-600">
              <p><strong>Faculty:</strong> faculty@lms.com / faculty123</p>
